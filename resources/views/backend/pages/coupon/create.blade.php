                ...
                <form action="{{ route('coupon.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" name="discount_amount" class="form-control @error('discount_amount')
                            is-invalid
                        @enderror" placeholder="Enter Discount" id="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" name="minimum_purchase_amount"  placeholder="Enter MP-Amount" class="form-control @error('minimum_purchase_amount')
                            is-invalid
                        @enderror">
